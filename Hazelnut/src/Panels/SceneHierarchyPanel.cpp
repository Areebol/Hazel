...
namespace Hazel {
	...
	void SceneHierarchyPanel::OnImGuiRender()
	{
		...
		if (!m_SelectionContext && ImGui::BeginPopupContextWindow("Create", 1))
		{
	...
	void SceneHierarchyPanel::DrawComponents(Entity entity)
	{
		...
		DrawComponent<SpriteRendererComponent>("Sprite Renderer", entity, [](auto& component) { ImGui::ColorEdit4("Color", glm::value_ptr(component.Color)); }
		);
